...
-->
					...
					<a href="/MushroomStreet/ToGoodAddServlet">添加商品</a>
				</form>
			</div>
			<!--账单表格 样式和供应商公用-->
			<table class="providerTable" cellpadding="0" cellspacing="0">
			   ...
			   <c:forEach items="${list}" var="l">
				<tr>
					<td>
						<span><img src="/MushroomStreet/src/${l.gphoto.split("&")[0] }" width="100px" height="100px" padding="10px"></span>
					</td>
					<td>
						<span>${l.gname }</span>
					</td>
					...
					<td>
						<span>${l.goodPrice }</span>
					</td>			
					<td>
					<span><a class="viewGood" href="javascript:;" goodName=${l.gname } goodId=${l.gid }><img src="/MushroomStreet/src/img/images/xiugai.png" alt="查看" title="查看"/></a></span>
					<span><a class="deleteProvider" href="javascript:;" goodName=${l.gname } goodId=${l.gid }><img src="/MushroomStreet/src/img/images/schu.png" alt="删除" title="删除"/></a></span>
					</td>
				</tr> 
			 </c:forEach>
			</table>
			...
			<li>共${requestScope.recordCount}条记录&nbsp;&nbsp;${requestScope.pages} 页</li>
				<a href="FindAllGoodsToShangpinguanServlet?method=select&page=${1}">首页</a>
                <a href="FindAllGoodsToShangpinguanServlet?method=select&page=${requestScope.currentPage<=1?1:requestScope.currentPage-1}">上一页</a>
                <a href="FindAllGoodsToShangpinguanServlet?method=select&page=${requestScope.currentPage>=requestScope.pages?requestScope.pages:requestScope.currentPage+1}">下一页</a>
                <a href="FindAllGoodsToShangpinguanServlet?method=select&page=${requestScope.pages}">最后一页</a>
				&nbsp;&nbsp;
			</ul>
...
<script type="text/javascript" src="/MushroomStreet/src/js/goodsrollpage.js"></script>
<script type="text/javascript" src="/MushroomStreet/src/js/providerlist.js"></script>