...
public class QueryFavoriteGidByUserServlet extends HttpServlet {
	 ...
	 */
	public QueryFavoriteGidByUserServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("QueryFavoriteGidByUserServlet-uname="+uname);
		if(uname!=null) {
			try {
				FavoriteDao dao = DAOFactory.getFavoriteServiceInstance();
				List<String> str = dao.queryGidByUname(uname);
